...
extern void TRAP_ENTRY(); // @suppress("Unused function declaration")
...
static void uart_init(size_t baud_rate) // @suppress("Unused static function") // @suppress("Type cannot be resolved")
{
